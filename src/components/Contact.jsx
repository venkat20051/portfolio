...
//     emailjs
//       .send(
//         'service_x7wosjv', // paste your ServiceID here (you'll get one when your service is created).
//         'template_kuufopj', // paste your TemplateID here (you'll find it under email templates).
//         {
//           from_name: form.name,
//           to_name: 'KOTHA VENKAT', // put your name here.
//           from_email: form.email,
//           to_email: 'venkatkotha456@gmail.com', //put your email here.
//           message: form.message,
//         },
//         'ZZ_-oeN8SmzIUMxG0' //paste your Public Key here. You'll get it in your profile section.
//       )
//       .then(
//         () => {
//           setLoading(false);
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        ...
        {
          from_name: form.name,
          to_name: 'KOTHA VENKAT',
          from_email: form.email,
          to_email: 'venkatkotha456@gmail.com',
          message: form.message,
        },
        'ZZ_-oeN8SmzIUMxG0'
      )
      ...
      <motion.div
        ...
        <form
          ...
          <button
            ...
            {loading ? 'Sending' : 'Send'}
            <img src={send} alt="send" className="contact-btn sm:w-[26px] sm:h-[26px] w-[23px] h-[23px] object-contain" />
          </button>
        </form>
